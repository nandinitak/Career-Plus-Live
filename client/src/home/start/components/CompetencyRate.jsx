...
const Skill = "React" | "Express" | "MongoDB";
const Level = "Novice" | "Average" | "Confident" | "Expert";

const skillIcons = {
  React: <MessageCircle className="w-4 h-4" />,
  Express: <Globe className="w-4 h-4" />,
  MongoDB: <Users className="w-4 h-4" />,
};

const levels = ["Novice", "Average", "Confident", "Expert"];

const skillExamples = {
  React: "e.g., Presenting ideas clearly",
  Express: "e.g., Conversing in a foreign language",
  MongoDB: "e.g., Guiding a team project",
};
...
export default function CompetencyRate() {
