...
export default function SkillDashboard() {
  ...
  return (
    <div className="min-h-screen  bg-background p-4 sm:p-6">
      ...
      >
        {/* Header */}
        <Card className="relative overflow-hidden rounded-lg p-4 sm:p-8">
          <CardContent>
            <motion.div
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold cp-text-gradient">
                    Skills Inventory
                  </h1>
                ...
                {selectedCategory !== "soft" && (
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    <Card className="text-center p-4">
                      <span className="text-4xl font-bold">
                        {
                          skills.filter(
                            (s) =>
                              s.category === selectedCategory && s.level <= 2
                          ).length
                        }
                      </span>
                      ...
                      <div className="h-1 bg-yellow-400 mt-2 rounded-full" />
                    </Card>
                    <Card className="text-center p-4">
                      <span className="text-4xl font-bold">
                        {
                      ...
                      <div className="h-1 bg-green-400 mt-2 rounded-full" />
                    </Card>
                    <Card className="text-center p-4">
                      <span className="text-4xl font-bold">
                        {
                          skills.filter(
                            (s) =>
                              s.category === selectedCategory && s.level > 5
                          ).length
                        }
                      </span>
                      <p className="text-sm text-muted-foreground mt-1">
                      ...
                      <div className="h-1 bg-gray-400 mt-2 rounded-full" />
                    </Card>
                  </div>
                )}
                    ...
                    <div className="mt-6">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Your most proficient abilities
                          </p>
                        </div>
                      </div>
                      <AnimatePresence>
                ...
                {skillQueue.length > 0 && (
                  <>
                    ...
                    <div className="mt-6">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h3 className="font-semibold">Skill Queue</h3>
                          <p className="text-sm text-muted-foreground">
                            Additional skills in your portfolio
                          </p>
                        </div>
                      </div>
              ...
              <ScrollArea className="h-[300px]">
                <div className="space-y-2">
                  {filteredSkills.map((skill) => (
                    <div
                      key={skill.id}
                      className="p-2 rounded-lg border bg-gradient-to-br from-background to-primary/5"
                    >
                      <div className="flex items-center gap-4">
                        <img
                          src={skill.icon}
