...
import HelpBrief from "@/modules/contribute/pages/HelpBrief";
import FeaturedWork from "@/modules/contribute/pages/FeaturedWork";

const navItems = [
  { label: "Brief", icon: <Command className="h-4 w-4" name="Help Brief" /> },
  { label: "Featured", icon: <Dumbbell className="h-4 w-4" /> },
  {
    label: "Back",
...
function ContributeLayout() {
  ...
  const [selectedComponent, setSelectedComponent] = useState("Brief");
  ...
  const renderComponent = () => {
    ...
    const SelectedComponent = componentMap[selectedComponent] || <HelpBrief />;
