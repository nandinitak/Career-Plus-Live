      ...
      <div className="flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Search for jobs using keywords, filter by language, category, or
...
export default function SearchJobs() {
  ...
  const indexOfLastEvent = currentPage * jobsPerPage;
  const indexOfFirstEvent = indexOfLastEvent - jobsPerPage;
      ...
      <div className="flex-1 flex flex-col">
        <header className="border-b p-4 sticky top-0 bg-background z-10">
          <div className="flex items-center mb-4">
            <h1 className="text-4xl font-bold cp-text-gradient">Search Jobs</h1>
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="ghost"
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>How to use Search Jobs</DialogTitle>
                </DialogHeader>
                <HelpCard />
              </DialogContent>
            </Dialog>
        ...
        <footer className="border-t p-4 sticky bottom-0 bg-background">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-muted-foreground">
              ...
              {Math.min(indexOfLastEvent, filteredAndSortedJobs.length)} of{" "}
            ...
            <Button
              ...
              onClick={() =>
                setCurrentPage((prev) =>
                  Math.min(
                    prev + 1,
                    Math.ceil(filteredAndSortedJobs.length / jobsPerPage)
                  )
                )
              }
              disabled={
